...
class PurchaseBillAddWidget extends StatefulWidget {
  final bool isDrawer;
  final bool? isEdit;
  final Map? data;
  final String? id;
  const PurchaseBillAddWidget(this.isDrawer,
      {Key? key, this.isEdit, this.data, this.id})
      : super(key: key);

  @override
  _PurchaseBillAddWidgetState createState() => _PurchaseBillAddWidgetState();
}

class _PurchaseBillAddWidgetState extends State<PurchaseBillAddWidget> {
  String radioButtonValue1 = 'Cash';
  DateTime datePicked = DateTime.now();
  TextEditingController? billingNameController;
  TextEditingController? billingNoController;
  ...
  void initState() {
    ...
    final salesData = Provider.of<PurchaseBillProvider>(context, listen: false);
    ...
    billingNoController = !widget.isEdit!
        ? TextEditingController(
            text: salesData.setBill(
                prefix: userData.userData!["billing_settings"]["purchase_bill"]
                    ["prefix"],
                number: userData.userData!["billing_settings"]["purchase_bill"]
                    ["starting_number"]))
        : TextEditingController(text: '${widget.data!['billing_no']}');
    if (widget.isEdit!) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return widget.isDrawer
        ? Scaffold(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  widget.isDrawer
                      ...
                      : context
                          .read<AuthProvider>()
                          .setCurrentPage(PurchaseBillListWidget(false));
                },
              ),
              title: Text(
                'Add Bill',
                            ...
                            onPressed: () async {
                              await salesData
                                ...
                                id: widget.id,
                                  ...
                                  .then((value) {
                                salesData.fetchpurchaseInvoice().then((value) =>
                                    widget.isDrawer
                                        ? Navigator.pop(context)
                                        : context
                                            .read<AuthProvider>()
                                            .setCurrentPage(
                                                PurchaseBillListWidget(false)));
                              });
                            },
                            icon: Icon(
                              Icons.delete,
              ...
              onPressed: () async {
                if (widget.isEdit!) {
                  await salesData
                    ...
                    billingNo: billingNoController!.text.trim(),
                    date: datePicked,
            ...
            body: SafeArea(
              child: _purchaseBillAddMain(context),
            ))
        : _purchaseBillAddMain(context);
  }

  Widget _purchaseBillAddMain(BuildContext context) {
    final itemData = Provider.of<ItemAddBill>(context);
          ...
          children: [
              ...
              children: [
                GestureDetector(
                        ...
                        builder: (context) => Container(
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    TextFormField(
                                      controller: billingNoController,
                                      validator: (value) {
                                      ...
                                      onChanged: (value) {
                                        setState(() {
                                          billingNoController!.text = value;
                                        });
                                      },
                                      autofocus: true,
                                      obscureText: false,
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      'Invoice no: ${billingNoController!.text}',
                      style: FlutterFlowTheme.of(context).bodyText1.override(
                            fontFamily: 'Poppins',
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                onChanged: (value) {
                  int ind = peopleData.suppliers.indexWhere(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Padding(
                          padding:
                              EdgeInsetsDirectional.fromSTEB(8, 20, 16, 16),
                          child: TextFormField(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text("Cant upload attachment")));
                  }
                },
