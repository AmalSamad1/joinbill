...
import 'payment_out_add_widget.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class PaymentOutListWidget extends StatefulWidget {
  final bool isDrawer;
  const PaymentOutListWidget(this.isDrawer, {Key? key}) : super(key: key);

  @override
  _PaymentOutListWidgetState createState() => _PaymentOutListWidgetState();
}

class _PaymentOutListWidgetState extends State<PaymentOutListWidget> {
  ...
  Widget build(BuildContext context) {
    return widget.isDrawer
        ? Scaffold(
              ...
              onPressed: () async {
                widget.isDrawer
                    ? await Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => PaymentOutAddWidget(
                            true,
                            data: {},
                            id: '',
                            isEdit: false,
                    ...
                    : context
                        .read<AuthProvider>()
                        .setCurrentPage(PaymentOutAddWidget(
                          false,
                          data: {},
                          id: '',
                          isEdit: false,
            ...
            body: SafeArea(
              child: _paymentOutListMain(context),
            ))
        : _paymentOutListMain(context);
  }

  Widget _paymentOutListMain(BuildContext context) {
    return FutureBuilder(
        future: Provider.of<PaymentOutProvider>(context, listen: false)
            .fetchSalesIn(),
                          ...
                          children: [
                            ...
                            salesData.salesIn == null
                                ...
                                : salesData.searchIns.isEmpty
                                    ? Center(
                                        child: Text(
                                            "no payments mathces your search!"),
                                      )
                                    : Column(
