...
import '../../providers/sales_providers/sale_order_provider.dart';
import 'purchase_order_add_widget.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class PurchaseOrderListWidget extends StatefulWidget {
  final bool isDrawer;
  const PurchaseOrderListWidget(this.isDrawer, {Key? key}) : super(key: key);
...
class _PurchaseOrderListWidgetState extends State<PurchaseOrderListWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
        future: Provider.of<PurchaseOederProvider>(context, listen: false)
            .fetchSalesOrder(),
              ...
              ? Scaffold(
                    ...
                    onPressed: () async {
                      widget.isDrawer
                          ? await Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => PurchaseOrderAddWidget(
                                  true,
                                  data: {},
                                  id: '',
                                  isEdit: false,
                  ...
                  body: snapShot.connectionState == ConnectionState.waiting
                      ...
                      : snapShot.connectionState == ConnectionState.waiting
                          ...
                          : _purchaseOrderListMain())
              : _purchaseOrderListMain();
        });
  }

  Widget _purchaseOrderListMain() {
            ...
            children: [
              ...
              salesData.salesOrder == null
                  ...
                  : salesData.searchOrders.isEmpty
                      ? Center(
                          child: Text("no Orders mathces your search!"),
                        )
                      : Column(
