...
import 'sale_invoice_add_widget.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class SalesInvoiceWidget extends StatefulWidget {
  final bool isDrawer;
  const SalesInvoiceWidget(this.isDrawer, {Key? key}) : super(key: key);

  @override
  _SalesInvoiceWidgetState createState() => _SalesInvoiceWidgetState();
}

class _SalesInvoiceWidgetState extends State<SalesInvoiceWidget> {
                  ...
                  floatingActionButton: FloatingActionButton(
                    ...
                    onPressed: () async {
                      await Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => SaleInvoiceAddWidget(
                            true,
                            data: {},
                            id: '',
                            isEdit: false,
  ...
  Widget _salesInvoiceMain() {
    return Consumer<SalesInvoiceProvider>(
                              ...
                              onTap: () async {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) => SaleInvoiceAddWidget(
                                        true,
                                        data: salesData.searchInvoices[index]
                                            .data(),
                                        isEdit: true,
